    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('participants', models.ManyToManyField(to='tournament.player')),
            ],
        ),
        migrations.CreateModel(
            name='Match',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('groups', models.ManyToManyField(blank=True, related_name='tournament_user_set', to='auth.group')),
                ('user_permissions', models.ManyToManyField(blank=True, related_name='tournament_user_set', to='auth.permission')),
            ],
            options={
                'verbose_name': 'user',
